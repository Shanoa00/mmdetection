...
test_pipeline = [
    ...
    dict(
        ...
        img_scale=[(480, 1024), (512, 1024), (544, 1024),
                                     ...
                                     (768, 1024), (800, 1024)],  # [(size, size) for size in range(768, 1280 + 1, 128)],  ##[(size / 1024) for size in range(768, 1280 + 1, 128)], [0.75, 0.875, 1.0, 1.125, 1.25]
        flip=False,
        transforms=[
            dict(type='Resize', keep_ratio=True),
            # dict(type='RandomFlip'),
...
checkpoint_config = dict(interval=20) #10
# yapf:disable
log_config = dict(
    interval=100,
    hooks=[
...
log_level = 'INFO'
work_dir = './work_dirs/convnext_nancho_pre_kuzh_mod'
