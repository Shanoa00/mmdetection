...
_base_ = 'cascade_rcnn/cascade_rcnn_x101_64x4d_fpn_1x_coco.py' #cascade_rcnn/cascade_rcnn_r50_caffe_fpn_1x_coco.py
...
data_root = '/home/mauricio/Documents/Pytorch/mmdetection/data/kuzushiji/'
...
optimizer = dict(
    type='SGD', lr=0.02 / 16 * 2, momentum=0.9, weight_decay=0.0001) #lr=0.02 / 16 * 2
...
log_level = 'INFO'
work_dir = './work_dirs/hr32_epochs'
# We can use the pre-trained Mask RCNN model to obtain higher performance
#load_from = 'checkpoints/cascade_mask_rcnn_x101_64x4d_fpn_mstrain_3x_coco_20210719_210311-d3e64ba0.pth' # mask_rcnn_r50_caffe_fpn_mstrain-poly_3x_coco_bbox_mAP-0.408__segm_mAP-0.37_20200504_163245-42aa3d00.pth
resume_from = './work_dirs/hr32_epochs/epoch_18.pth'
