...
dataset_name= 'S05_Detection&Recognition/'  #kuzushiji, #HanDataset,  #Nancho_dataset,
...
data = dict(
    ...
    train=dict(
        ...
        type=dataset_type,
        classes=classes,
        ann_file=data_root + 'dtrain_crop2.pkl',  #dtrain_crop2.pkl, 'dtrain_crop1240.pkl', 0dtrain_crop (last used in scale folder)
        img_prefix=data_root + 'train_crops2/',  #train_crops2, 'train_crops1240/', 0train_crops1
...
log_level = 'INFO'
work_dir = './work_dirs/' + dataset_name+'fpn/' #swin_kuzushiji, swin_nancho_deformable2, swin_nancho_deformable2/scales, S03/swin_t
